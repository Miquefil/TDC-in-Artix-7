...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ block_clock_clk_wiz_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_block_clock_clk_wiz_0_0_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_block_clock_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_block_clock_clk_wiz_0_0_clk_wiz is
  ...
  signal clk_out4_block_clock_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out_block_clock_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_block_clock_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_buf_block_clock_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFHCE
    generic map(
      CE_TYPE => "SYNC",
      INIT_OUT => 0,
      IS_CE_INVERTED => '0'
...
clkout2_buf: unisim.vcomponents.BUFHCE
    generic map(
      CE_TYPE => "SYNC",
      INIT_OUT => 0,
      IS_CE_INVERTED => '0'
...
clkout3_buf: unisim.vcomponents.BUFHCE
    generic map(
      CE_TYPE => "SYNC",
      INIT_OUT => 0,
      IS_CE_INVERTED => '0'
...
clkout4_buf: unisim.vcomponents.BUFHCE
    generic map(
      CE_TYPE => "SYNC",
      INIT_OUT => 0,
      IS_CE_INVERTED => '0'
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_block_clock_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out => clk_out,
