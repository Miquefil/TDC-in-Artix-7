...
set_property IOSTANDARD SSTL15      [get_ports startReading]
# set_property PACKAGE_PIN P5 [get_ports VTTVREF]
# set_property IOSTANDARD SSTL15 [get_ports VTTVREF]
set_property PACKAGE_PIN T5         [get_ports startWriting]
set_property IOSTANDARD SSTL15      [get_ports startWriting]
...
set_property PACKAGE_PIN T8 [get_ports hit]
set_property IOSTANDARD SSTL15 [get_ports hit]
