...
set_property IOSTANDARD LVCMOS33 [get_ports led_WriteERR]
set_property PACKAGE_PIN T24 [get_ports led_ReadERR]
set_property IOSTANDARD LVCMOS33 [get_ports led_ReadERR]
set_property PACKAGE_PIN T25 [get_ports led_WriteStage]
set_property IOSTANDARD LVCMOS33 [get_ports led_WriteStage]
set_property PACKAGE_PIN R26 [get_ports led_ReadStage]
set_property IOSTANDARD LVCMOS33 [get_ports led_ReadStage]
...
set_property IOSTANDARD SSTL15 [get_ports but_startReading]
# set_property PACKAGE_PIN P5 [get_ports VTTVREF]
# set_property IOSTANDARD SSTL15 [get_ports VTTVREF]
set_property PACKAGE_PIN U5 [get_ports but_startWriting]
set_property IOSTANDARD SSTL15 [get_ports but_startWriting]
...
set_property IOSTANDARD SSTL15 [get_ports but_debugmode]
set_property PACKAGE_PIN R5 [get_ports but_debugmode]
# set_property IOSTANDARD SSTL15  [get_ports but_rst]
# set_property PACKAGE_PIN R6     [get_ports but_rst]
